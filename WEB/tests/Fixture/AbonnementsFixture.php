 ...
 * AbonnementsFixture
 */
class AbonnementsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'plan_id_stripe' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => '0', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'plan_id_stripe' => 'Lorem ipsum dolor sit amet'
            ],
        ];
        parent::init();
    }
