...
export const backgroundColor = colors.green + "00"; // Agenda's reservations bg color
...
// export const calendarBackground = colors.green + "00";
export const calendarBackground = colors.green + "00";
...
export const dayTextColor = colors.white;
export const textDisabledColor = '#3c3c3c';
...
export const monthTextColor = colors.white;
