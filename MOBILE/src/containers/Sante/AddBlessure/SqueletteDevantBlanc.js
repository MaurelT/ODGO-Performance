          ...
          <View style={{alignSelf:'center',backgroundColor:'transparent',marginVertical:10,marginLeft:-4}}>
            <TouchableOpacity
                    onPress={()=>{
                       ...
                       this.props._selectedId(1,'Tête avant',this.state.tete)
                    }}
                    style={{marginLeft:-screenWidth*0.004,alignSelf:'center'}}>
                ...
                <TouchableOpacity
                    onPress={()=>{
                        ...
                        this.setState({brasdroite:false})
                        this.setState({maindroite:false})
                        this.props._selectedId(2,'Cervicale avant',this.state.cou)

                    }}
                     style={{marginTop:-screenWidth*0.02,marginLeft:-screenWidth*0.004,alignSelf:'center'}}
                    >
                    ...
                    <View>
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.props._selectedId(11,'Epaule / Biceps droit',this.state.epaulegauche)


                            }}
                            style={{right:-screenWidth*0.06,top:-screenWidth*0.036,}}
                        >
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.props._selectedId(12,'Coude / Avant bras droit',this.state.brasgauche)


                            }}
                            style={{left:screenWidth*0 ,top:-screenWidth*0.065,}}
                        >
                            ...
                            onPress={()=>{
                                ...
                                this.setState({brasdroite:false})
                                this.setState({maindroite:false}) //gauche changé en droite
                                this.props._selectedId(13,'Poignet / Main droit',this.state.maingauche)


                            }}
                            style={{width:60,height:60,backgroundColor:'transparent',left:-screenWidth*0.085 ,top:-screenWidth*0.085}}
                        >
                        ...
                        {/*console.warn('baba')}} style={{width:90,height:90,backgroundColor:'transparent',position:'absolute',left:-50,top:100}}></TouchableOpacity>*/}
                    ...
                    <View>
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.setState({brasdroite:false})
                                this.setState({maindroite:false})
                                this.props._selectedId(3,'Thoracique',this.state.poitrine)
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.setState({brasdroite:false})
                                this.setState({maindroite:false})
                                this.props._selectedId(4,'Abdos',this.state.bassin)
                            ...
                            <View style={{}}>
                                <TouchableOpacity
                                    onPress={()=>{
                                        ...
                                        this.setState({brasdroite:false})
                                        this.setState({maindroite:false}) //gauche changé en droite
                                        this.props._selectedId(14,'Cuisse / Hanche droite',this.state.cuissegauche)
                                    }}
                                    style={{top:-screenWidth*0.15,left:-screenWidth*0.012,}}
                                >
                                ...
                                <View style={{}}>
                                    <TouchableOpacity
                                        onPress={()=>{
                                            ...
                                            this.setState({brasdroite:false})
                                            this.setState({maindroite:false}) //gauche changé en droite
                                            this.props._selectedId(15,'Genoux / Mollet droit',this.state.jambegauche)
                                    ...
                                    <TouchableOpacity
                                        onPress={()=>{
                                            ...
                                            this.setState({brasdroite:false})
                                            this.setState({maindroite:false}) //gauche changé en droite
                                            this.props._selectedId(16,'Pied / Cheville droite',this.state.piedgauche)


                                        }}
                                        style={{top:-screenWidth*0.178,left:-screenWidth*0.037,}}
                                    >
                            ...
                            <View style={{}}>
                                <TouchableOpacity
                                    onPress={()=>{
                                        ...
                                        this.props._selectedId(8,'Cuisse / Hanche gauche',this.state.cuissedroite)
                                ...
                                <View style={{}}>
                                    <TouchableOpacity
                                        onPress={()=>{
                                            ...
                                            this.setState({brasdroite:false})
                                            this.setState({maindroite:false}) //droite changé en gauche
                                            this.props._selectedId(9,'Genoux / Mollet gauche',this.state.jambedroite)
                                    ...
                                    <TouchableOpacity
                                        onPress={()=>{
                                            ...
                                            this.setState({brasdroite:false})
                                            this.setState({maindroite:false}) //droite changé en gauche
                                            this.props._selectedId(10,'Pied / Cheville gauche',this.state.pieddroite)
                    ...
                    <View style={{}}>
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.setState({brasdroite:false})
                                this.setState({maindroite:false}) //droite changé en gauche
                                this.props._selectedId(5,'Epaule / Biceps gauche',this.state.epauledroite)

                            }}
                            style={{left:-screenWidth*0.041,top:-screenWidth*0.037}}
                        >
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.setState({maindroite:false}) //droite changé en gauche
                                this.props._selectedId(6,'Coude/Avant bras gauche',this.state.brasdroite)

                            }}
                            style={{top:-screenWidth*0.064,left:-screenWidth*0.003}}
                        >
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.props._selectedId(7,'Poignet / Main gauche',this.state.maindroite)
                            }}
                            style={{top:-screenWidth*0.078,right:-screenWidth*0.09}}
                        >
