            ...
            <View style={{alignSelf:'center',backgroundColor:'transparent',marginVertical:10}}>
                ...
                <TouchableOpacity
                    onPress={()=>{
                        ...
                        this.props._selectedId(17,'Tête dérrière',this.state.tete)
                ...
                <TouchableOpacity
                    onPress={()=>{
                        ...
                        this.setState({brasdroite:false})
                        this.setState({maindroite:false})
                        this.props._selectedId(18,'Cou dérrière',this.state.cou)
                    ...
                    <View>
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.props._selectedId(27,'Omoplate gauche',this.state.epaulegauche)
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.props._selectedId(28,'Bras gauche',this.state.brasgauche)
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.setState({brasdroite:false})
                                this.setState({maindroite:false})  //gauche changé en droite
                                this.props._selectedId(29,'Main gauche',this.state.maingauche)
                    ...
                    <View>
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.setState({brasdroite:false})
                                this.setState({maindroite:false})
                                this.props._selectedId(22,'Bassin',this.state.bassin)
                            ...
                            <View style={{}}>
                                <TouchableOpacity
                                    onPress={()=>{
                                        ...
                                        this.setState({brasdroite:false})
                                        this.setState({maindroite:false})  //gauche changé en droite
                                        this.props._selectedId(30,'Cuisse gauche',this.state.cuissegauche)
                                ...
                                <View style={{}}>
                                    <TouchableOpacity
                                        onPress={()=>{
                                            ...
                                            this.setState({brasdroite:false})
                                            this.setState({maindroite:false})  //gauche changé en droite
                                            this.props._selectedId(31,'Jambe gauche',this.state.jambegauche)
                                    ...
                                    <TouchableOpacity
                                        onPress={()=>{
                                            ...
                                            this.setState({brasdroite:false})
                                            this.setState({maindroite:false})  //gauche changé en droite
                                            this.props._selectedId(32,'Pied gauche',this.state.piedgauche)
                            ...
                            <View style={{}}>
                                <TouchableOpacity
                                    onPress={()=>{
                                        ...
                                        this.props._selectedId(24,'Cuisse droite',this.state.cuissedroite)
                                ...
                                <View style={{}}>
                                    <TouchableOpacity
                                        onPress={()=>{
                                            ...
                                            this.setState({brasdroite:false})
                                            this.setState({maindroite:false}) //droite changé en gauche
                                            this.props._selectedId(25,'Jambe droite',this.state.jambedroite)
                                    ...
                                    <TouchableOpacity
                                        onPress={()=>{
                                            ...
                                            this.setState({brasdroite:false})
                                            this.setState({maindroite:false}) //droite changé en gauche
                                            this.props._selectedId(26,'Pied droit',this.state.pieddroite)
                    ...
                    <View style={{}}>
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.setState({brasdroite:false})
                                this.setState({maindroite:false})  //droite changé en gauche
                                this.props._selectedId(20,'Epaule droite',this.state.epauledroite)
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.setState({maindroite:false}) //droite changé en gauche
                                this.props._selectedId(21,'Bras droit',this.state.brasdroite)
                        ...
                        <TouchableOpacity
                            onPress={()=>{
                                ...
                                this.props._selectedId(23,'Main droite',this.state.maindroite)
