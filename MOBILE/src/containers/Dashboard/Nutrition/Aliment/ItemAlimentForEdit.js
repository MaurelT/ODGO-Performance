                                                            ...
                                                            return(
                                                                <TouchableOpacity
                                                                    onPress={()=>{
                                                                        ...
                                                                        if( this.props.navigation.navigate('MesProduits_NosSuggesstion_Item',{alimentss:alimentss,item:item,item1:item1,edit:true,aliment_id:item1.id,suggestion_id:item1.suggestion_id,addrepas:true,ajoutrepaspouredition:true})){}
                                                                        else{
                                                                            this.props.navigation.navigate('MesProduits_NosSuggesstion_Item_dashboard',{alimentss:alimentss,item:item,item1:item1,edit:true,aliment_id:item1.id,suggestion_id:item1.suggestion_id,addrepas:true,ajoutrepaspouredition:true})
                                                                        }
                                                                    }}
                                                                    style={{  //item1
                                                                        flexDirection:'row',
...
const mapStateToProps = (state) => {
    const { userToken,ArrayAlimentEdit,nosSuggestions,ArrayAlimentCreate,nosSuggestionssearch} = state.statedata
    return { userToken,ArrayAlimentEdit,nosSuggestions,ArrayAlimentCreate,nosSuggestionssearch}
};
