...
import { Container, Header,Body, Content, Tab, Tabs, Left, Right, Button, Icon, Title, TabHeading, Footer, FooterTab  } from 'native-base';
...
import {getViaPostPetitsDejeuner, monassiete,getViaPostRepas,search} from '../../../../apis/FonctionRedondant';
...
class Petitdejeuner  extends Component {
    ...
    actualisefirst(){
        ...
        setTimeout(this._tabs.goToPage.bind(this._tabs,0),20);
        setTimeout(this._tabs.goToPage.bind(this._tabs,0),30);
    }
    ...
    componentDidMount() {
        ...
        console.warn('ko',this.props.navigation.state.params.venurepas)
        if(this.props.navigation.state.params.venurepas===true){
            this.actualisesecond()
        }else{
            this.actualisefirst()
        }
    };
    ...
    save_alimentMesRepas = async (idaliment,daty) => {
        this.setState({refreshing: true});
    ...
    FirstRoute = () => {
        return(
            <ScrollView
                ...
                contentContainerStyle={{width:'100%',marginTop:screenWidth*0.005,paddingBottom:200}}>
    ...
    FirstRouteSearch_NosSuggestion = () => {
        return(
            <ScrollView
                ...
                contentContainerStyle={{width:'100%',marginTop:0,paddingBottom:150}}
            >
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} colors={[colors.balck, colors.green,  '#213D2E']} style={{paddingBottom:screenWidth}}>
                    {
                        this.props.filteredNosSuggestionfiltered.length > 0 ?
                        this.props.filteredNosSuggestionfiltered.map(
                                (item,index)=>{
                                   if(item.name ) {
                                       return (
                                           <View style={{
                                    ...
                                    <View style={{width:'20%',justifyContent:'center',alignItems:'flex-end',marginRight:10,}}>
                                        <TouchableOpacity
                                            onPress={()=>{
                                                ...
                                                this.save_alimentMesRepas(item1.id, this.props.dateforajoutaliment)
                                            }}
        ...
        return(
            <ScrollView
                ...
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} colors={[colors.balck, colors.green,  '#213D2E']} style={{width:'100%',paddingBottom:screenWidth}}>
                    {
                        this.props.filteredmesRepaspetitsdejeunerfiltered.length > 0 ?
                            this.props.filteredmesRepaspetitsdejeunerfiltered.map(
                                (item1)=>{
                                    return(
    ...
    SecondRouteSearch_Collationmatin = () => {
        return(
            <ScrollView
                ...
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} colors={[colors.balck, colors.green,  '#213D2E']} style={{width:'100%',paddingBottom:screenWidth}}>
                    {
                        this.props.filteredCollationmatinfiltered.length > 0 ?
                            this.props.filteredCollationmatinfiltered.map(
                                (item1)=>{
                                    return(
                                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',width:'100%',height:screenWidth*0.13,backgroundColor:'#213D2E',marginBottom:2}}>
                                            <TouchableOpacity
    ...
    SecondRouteSearch_Dejeuner = () => {
        return(
            <ScrollView
                ...
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} colors={[colors.balck, colors.green,  '#213D2E']} style={{width:'100%',paddingBottom:screenWidth}}>
                    {
                        this.props.filteredDejeunerfiltered.length > 0 ?
                            this.props.filteredDejeunerfiltered.map(
                                (item1)=>{
                                    return(
                                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',width:'100%',height:screenWidth*0.13,backgroundColor:'#213D2E',marginBottom:2}}>
                                            <TouchableOpacity
        ...
        return(
            <ScrollView
                ...
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} colors={[colors.balck, colors.green,  '#213D2E']} style={{width:'100%',height:screenHeight}}>
                    {
                        this.props.filteredCollationApresMidifiltered.length > 0 ?
                            this.props.filteredCollationApresMidifiltered.map(
                                (item1)=>{
                                    return(
                                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',width:'100%',height:screenWidth*0.13,backgroundColor:'#213D2E',marginBottom:3}}>
                                            <TouchableOpacity
    ...
    SecondRouteSearch_Diner = () => {
        return(
            <ScrollView
                ...
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} colors={[colors.balck, colors.green,  '#213D2E']} style={{width:'100%',paddingBottom:screenWidth}}>
                    {
                        this.props.filteredDinerfiltered.length > 0 ?
                            this.props.filteredDinerfiltered.map(
                                (item1)=>{
                                    return(
                                        <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',width:'100%',height:screenWidth*0.13,backgroundColor:'#213D2E',marginBottom:2}}>
                                            <TouchableOpacity
        ...
        return (
            <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} colors={[colors.balck, colors.green,  '#213D2E']} style={{flex:1}}>
                ...
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }} colors={[colors.balck, colors.green,  '#213D2E']} style={{
                    ...
                    <View style={{}}>
                        <TouchableOpacity onPress={()=>{
                            search(this.state.textSearch,this.props,filteredNosSuggestionfiltered,filteredmesRepaspetitsdejeunerfiltered,filteredEatRecentlyfiltered,filteredCollationmatinfiltered,filteredDejeunerfiltered,filteredCollationApresMidifiltered,filteredDinerfiltered,createFilter);
                            Keyboard.dismiss();
                        }}
                ...
                <Tabs
                    ...
                    // onSwipe={()=>console.warn('swipe')}
                    tabContainerStyle={{ height:screenHeight * 0.055 }}
                    ref={component => this._tabs = component}
                    onChangeTab={({i}) => this.setState({ currentPage: i })}
                    tabBarUnderlineStyle={{backgroundColor:"red"}} tabBarPosition = "overlayTop">
                    <Tab
                         style={{ backgroundColor: '#213D2E' }}
                        heading = {<TabHeading  style = {{backgroundColor: '#213D2E'}} >
                            <TouchableOpacity
                                onPress={()=>{
                                    this.actualisefirst()
                                }}
                                style={{flexDirection:'column',alignItems:'center',backgroundColor: '#213D2E',top:0}}>
                                <Text style={{ color:'#FF3A28',fontSize:13}}>Nos suggestions</Text>
                            </TouchableOpacity>
                        </TabHeading>}
                    >
                        {
                            <View style={{backgroundColor: '#15261d',width:'100%',alignItems:'center',paddingVertical:7}}>
                                <Text style={{color:'#afb7bf',fontSize:11,}}>Pour atteindre votre objectif, sélectionnez un aliment par famille</Text>
                            </View>
                        }
                        {this.FirstRouteSearch_NosSuggestion()}
                    </Tab>
                    <Tab
                        style={{ backgroundColor: '#213D2E' }}
                        heading = {<TabHeading  style = {{backgroundColor: '#213D2E'}} >
                            <TouchableOpacity
                                ...
                                style={{flexDirection:'column',alignItems:'center',backgroundColor: '#213D2E',top:-5}}>
                                <Text style={{ color:'#FF3A28',fontSize:13}}>Mes repas</Text>
                            </TouchableOpacity>
                        </TabHeading>}
                    >
                        {//le index, index tabview
                        ...
                        {  this.state.indexrepas == 0 && this.SecondRouteSearch_PetitsDejeuner()}
                        {  this.state.indexrepas == 1 && this.SecondRouteSearch_Collationmatin()}
                        {  this.state.indexrepas == 2 && this.SecondRouteSearch_Dejeuner()}
                        {  this.state.indexrepas == 3 && this.SecondRouteSearch_CollationApresMidi()}
                        {  this.state.indexrepas == 4 && this.SecondRouteSearch_Diner()}
                    </Tab>
                </Tabs>
                </View>
            </LinearGradient>
...
const mapStateToProps = (state) => {
    const { filteredNosSuggestionfiltered,
        ...
        filteredDejeunerfiltered,
        filteredCollationApresMidifiltered,
        filteredDinerfiltered,selectedZone,nosSuggestionssearch,dateforajoutaliment, userToken,nosSuggestions,repasType ,mesRepaspetitsdejeuner,dejeuner,eatrecently,ArrayAlimentEdit,collationmatin,collationapresmidi,diner} = state.statedata
    return { filteredNosSuggestionfiltered,
        ...
        filteredDejeunerfiltered,
        filteredCollationApresMidifiltered,
        filteredDinerfiltered,selectedZone,nosSuggestionssearch,dateforajoutaliment, userToken,nosSuggestions,repasType ,mesRepaspetitsdejeuner,dejeuner,eatrecently ,ArrayAlimentEdit,collationmatin,collationapresmidi,diner}
};
