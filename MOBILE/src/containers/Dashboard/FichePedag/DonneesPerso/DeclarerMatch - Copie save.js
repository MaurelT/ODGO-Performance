                ...
                >
                    ...
                    <View style={[styles.sliderCtn]}>
                        ...
                        <View style={[styles.sliderTensionLabelD]}>
                            <TouchableOpacity
                                onPress={()=>{
                                    this.setState({isWritingScore:!this.state.isWritingScore})
                                }}
                            >
                    ...
                    <View style={[styles.sliderCtn]}>
                        ...
                        <View style={[styles.sliderTensionLabelD]}>
                            <TouchableOpacity
                                onPress={()=>{
                                    this.setState({isWritingStatut:!this.state.isWritingStatut})
                                }}
                            >
                                    ...
                                    <View>
                                        <TouchableOpacity
                                            style={{
                                                ...
                                                zIndex: 1000}}
                                            onPress={()=>{
                                                this.setState({ isWritingStatut: false })
                                            }}
                                        ><Image
                                            style={{width:20,
                                                height:20,
                    ...
                    <View style={[styles.sliderCtn]}>
                        ...
                        <View style={[styles.sliderTensionLabelD]}>
                            <TouchableOpacity
                                onPress={()=>{
                                    this.setState({isWritingTempdejeu:!this.state.isWritingTempdejeu})
                                }}
                            >
                                    ...
                                    <View>
                                        <TouchableOpacity
                                            style={{
                                                ...
                                                zIndex: 1000}}
                                            onPress={()=>{
                                                this.setState({ isWritingTempdejeu: false })
                                            }}
                                        ><Image
                                            style={{width:20,
                                                height:20,
                                        ...
                                        ><TextInput
                                            value={"" + this.state.userTempdejeu}
                                            onChangeText={(text) => {
                    ...
                    <View style={[styles.sliderCtn]}>
                        ...
                        <View style={styles.sliderTensionLabelD}>
                            <TouchableOpacity
                                onPress={()=>{
                                    this.setState({isWritingButs:!this.state.isWritingButs})
                                }}
                            >
                                    ...
                                    <View>
                                        <TouchableOpacity
                                            style={{
                                                ...
                                                zIndex: 1000}}
                                            onPress={()=>{
                                                this.setState({ isWritingButs: false })
                                            }}
                                        ><Image
                                            style={{width:20,
                                                height:20,
                    ...
                    <View style={[styles.sliderCtn]}>
                        ...
                        <View style={styles.sliderTensionLabelD}>
                            <TouchableOpacity
                                onPress={()=>{
                                    this.setState({isWritingPasses:!this.state.isWritingPasses})
                                }}
                            >
                                    ...
                                    <View>
                                        <TouchableOpacity
                                            style={{
                                                ...
                                                zIndex: 1000}}
                                            onPress={()=>{
                                                this.setState({ isWritingPasses: false })
                                            }}
                                        ><Image
                                            style={{width:20,
                                                height:20,
                    ...
                    <View style={[styles.sliderCtn]}>
                        ...
                        <View style={styles.sliderTensionLabelD}>
                            <TouchableOpacity
                                onPress={()=>{
                                    this.setState({isWritingRouge:!this.state.isWritingRouge})
                                }}
                            >
                                    ...
                                    <View>
                                        <TouchableOpacity
                                            style={{
                                                ...
                                                zIndex: 1000}}
                                            onPress={()=>{
                                                this.setState({ isWritingRouge: false })
                                            }}
                                        ><Image
                                            style={{width:20,
                                                height:20,
                    ...
                    <View style={[styles.sliderCtn]}>
                        ...
                        <View style={styles.sliderTensionLabelD}>
                            <TouchableOpacity
                                onPress={()=>{
                                    this.setState({isWritingJaune:!this.state.isWritingJaune})
                                }}
                            >
                                    ...
                                    <View>
                                        <TouchableOpacity
                                            style={{
                                                ...
                                                zIndex: 1000}}
                                            onPress={()=>{
                                                this.setState({ isWritingJaune: false })
                                            }}
                                        ><Image
                                            style={{width:20,
                                                height:20,
